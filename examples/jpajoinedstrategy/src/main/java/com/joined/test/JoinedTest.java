...
public class JoinedTest {
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * CardPayment payment = entityManager.find(CardPayment.class, 4);
			 * System.out.println(payment); CardPayment payment1 =
			 * entityManager.find(CardPayment.class, 2); System.out.println(payment1);
			 */

			/*
			 * ChequePayment payment = entityManager.find(ChequePayment.class, 4);
			 * System.out.println(payment); ChequePayment payment1 =
			 * entityManager.find(ChequePayment.class, 3); System.out.println(payment1);
			 */

			Payment payment = entityManager.find(Payment.class, 1);
			System.out.println(payment);
			Payment payment1 = entityManager.find(Payment.class, 2);
			System.out.println(payment1);
			Payment payment2 = entityManager.find(Payment.class, 3);
