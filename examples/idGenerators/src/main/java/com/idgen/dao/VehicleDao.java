...
public class VehicleDao {
	 ...
	 * 
	 * SessionFactory sessionFactory = null; Transaction transaction = null; Session
	 * session = null; boolean flag = false; int vehicleNo = 0;
	 * 
	 * try { sessionFactory = SessionFactoryRegistry.getSessionFactory(); session =
	 ...
	 * transaction.rollback(); } } if(session!=null) { session.close(); } } return
	 * vehicleNo; }
	 */
