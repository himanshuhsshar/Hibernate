...
public class SingleTableTest {
	public static void main(String[] args) {
		...
		try {
			 ...
			 * entityManager.find(ChequePayment.class, 5); System.out.println(payment1);
			 */
			
			
			Payment payment = entityManager.find(Payment.class, 3);
			System.out.println(payment);
			Payment payment1 = entityManager.find(Payment.class, 4);
			System.out.println(payment1);
			Payment payment2 = entityManager.find(Payment.class, 5);
